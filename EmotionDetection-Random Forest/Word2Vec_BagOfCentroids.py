...
if __name__ == '__main__':
    ...
    model = Word2Vec.load("100features_5minwords_5context")
    ...
    output.to_csv("C:\Users\Shaik Riyaz\Desktop\code\python files\BagOfCentroids.csv", index=False, quoting=3)
